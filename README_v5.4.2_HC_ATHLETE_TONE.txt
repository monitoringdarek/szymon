Szymon AI Coach PRO — v5.4.2-HC-athlete-tone-hotfix-local
...
HOTFIX ATHLETE TONE:
- Decyzje są bardziej sportowe: TRENING / KONTROLOWANY TRENING / ODBUDOWA.
- Regeneracja jest opisana jako element progresu i przygotowanie do następnej jakościowej pracy, nie jako miękkie odpuszczanie.
- AI ma nie używać słów typu D+1/D0/Baseline/Recovery ani nie nadużywać „wczoraj”.
- Główna lista ostatnich treningów nie pokazuje technicznych load/IF; liczby zostają w szczegółach danych.
